...
const services: TypeService[] = [
  {
    ...
    description: "Potencialize seu negócio com um site único e impactante! Desenvolvimento profissional, design moderno, responsivo e otimizado para buscadores. Atraia mais clientes e alcance o sucesso online!",
    link: hostLinks.services["desenvolvimento-de-site"]
  },
  {
    title: "Desenvolvimento de Página de Vendas",
    icon: <i className='bx bxs-book-content'></i>,
    description: "Aumente suas conversões com páginas de vendas irresistíveis! Desenvolvimento profissional, layout persuasivo e copywriting estratégico. Maximize seus resultados e impulsione suas vendas!",
    link: hostLinks.services["desenvolvimento-de-pagina-de-vendas"]
  },
  {
    title: "Desenvolvimento de Ecommerce",
    icon: <i className='bx bxs-shopping-bags'></i>,
    description: "Crie sua loja virtual de sucesso! Desenvolvimento de e-commerce profissional, funcionalidades avançadas, design atrativo e integração de pagamento segura. Venda online de forma eficiente!",
    link: hostLinks.services["desenvolvimento-de-ecommerce"]
  },
  {
    ...
    link: hostLinks.services["desenvolvimento-de-aplicativo-mobile"]
  },
  {
    ...
    link: hostLinks.services["desenvolvimento-de-chatbot-e-assistente"]
  },
  {
    ...
    link: hostLinks.services["design-grafico"]
  },
  {
    title: "UX/UI Design",
    ...
    link: hostLinks.services["ux-ui-design"]
  },
  {
    title: "Social Media",
    ...
    link: hostLinks.services["social-media"]
  },
  {
