...
const Checkboxes = ({ label, options, onChange, id, className, defaultValues, helperText, error = false }: ICheckboxesProps): JSX.Element => {
  ...
  return (
    <S.Checkboxes className={className} id={id} error={error}>
